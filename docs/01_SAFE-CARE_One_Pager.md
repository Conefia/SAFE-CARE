...
[Case Study] Design case study — a conversational AI companion for menopause and perimenopause support (author’s prior applied work). [Conference Outline] Conference talk outline — “Building Safe Conversational AI Agents for Healthcare.”
